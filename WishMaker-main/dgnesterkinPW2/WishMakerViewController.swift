...
final class WishMakerViewController: UIViewController {
    ...
    private func configureHexButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            hexButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 40),
            hexButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -40)
        ])
    }
    ...
    private func configureRandomColorButton() {
        ...
        NSLayoutConstraint.activate([
            ...
            randomColorButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 40),
            randomColorButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -40)
        ])
    }
